...
bat += analogRead(A0);
bat = bat * (5.0/1023.0);           //sumowanie kolejnych pomiarów
bat1 = bat*2;
...
void logo6() { // TEMP WILG
  ...
  /////////////////temp. humidity SCREEN 
          u8g.drawStr(0,35, "CALIBRATION");//1-szer ,2-wysokosc
          //delay(500);
...
void screens() {
  ...
  uint8_t a;
    //u8g.setFont(u8g_font_profont17);//10-17
          ...
          //delay(500);
          //u8g.drawStr( 0, 0, "drawRFrame/Box");
          u8g.drawRFrame(58, 30,70,30, a+1); //1-ys, 2-, 3szer, 4-wysokosc famki
