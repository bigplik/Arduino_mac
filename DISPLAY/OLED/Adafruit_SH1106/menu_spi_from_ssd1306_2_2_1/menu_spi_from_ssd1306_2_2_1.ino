  ...
  switch(tabela){
    ...
    case 0:
      ...
      buttonState2 = digitalRead(pushButton2);
        back();
        //move to other value in menu
        if(buttonState == HIGH){
          tabela ++;
        }else
        if(buttonState2 == HIGH){
        //wyjście z menu całkowite  
        }
        break;
    ...
    case 2://FLIP SCREEN
      ...
      buttonState2 = digitalRead(pushButton2);
        ...
        if(buttonState == HIGH){
          //wyjście do kolejnej czesci menu
          tabela ++;
        }
        switch(obrot){
          case 0:
              //normal screen adafruit code
              //display.clearDisplay();
              display.setRotation(4);
              display.display();
              break;
          case 1:
              //flip screen adafruit code
              //display.clearDisplay();
      ...
      height();
         switch(jasnosc){
                case 0:
                    ...
                    display.SH1106_command(85);
                    break;
                case 1:
                    //Serial.println("Brightness 2");
                    display.SH1106_command(SH1106_SETCONTRAST);
                    display.SH1106_command(170);
                    break;
                case 2:
                    //Serial.println("Brightness 3");
                    display.SH1106_command(SH1106_SETCONTRAST);
                    display.SH1106_command(255);
                    break;
         }
        break;
