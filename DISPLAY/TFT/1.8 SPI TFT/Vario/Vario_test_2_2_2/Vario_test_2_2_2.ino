...
void loop() {
  ...
  realAlt = bmp.readAltitude(101325);
  realAltcorrect = realAlt - correct;
      ...
      case 1:
        switch(change2){
          case 'a':
            ...
            tft.setCursor(112,100);  //
            tft.setTextSize(2); tft.print(minutes); //tft.print("C");
            tft.setCursor(117,117);
...
int checkSensor(){
  //sw_secs.stop();
  int newDeniwelacja = maximum - minimum;
  int realAltcorrect2 = realAlt - correct;
  //int maximum2 = realAltcorrect;
...
//   tft.setCursor(25,90);
//   tft.print(newDeniwelacja);
//   tft.setCursor(25,107);
//   tft.setTextSize(1);
//   tft.print("deniw2");
//   tft.setCursor(35,90);
//   tft.print(sw_mils.value());
   if(sw_mils.value()>60000){ change2 = 'b'; }
  }
  else{
    sw_mils.reset();// sw_mils.reset();
    //Serial.print("mils "); Serial.println(sw_mils.value());
