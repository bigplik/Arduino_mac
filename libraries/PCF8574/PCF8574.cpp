...
/*
//alternatywa dla ESP8266 na razie nie działa
void PCF8574::begin(uint8_t address, uint8_t sda, uint8_t clk) {
	_address = address;
	Wire.begin(sda,clk);
	read(GPIO);//this is from original settings i2c
} // End of setPins
*/
