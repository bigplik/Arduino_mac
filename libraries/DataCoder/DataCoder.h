...
#define UNION_EXPANSION_FACTOR 4//was 2 //The number of bytes occupied by each element of the encoded RFData packet. This data is 
...
//was bool instead void
bool RFLinkDataAvailable(uint8_t* buf, uint8_t* buflen); //was uint8_t
