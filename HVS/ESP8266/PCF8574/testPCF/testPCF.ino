...
char auth[] = "4kpVKNFsmldVPQWXXMFvQ2TcPF6gWlbC";

// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = "HVS";
char pass[] = "GPZHVS2015";
...
BLYNK_WRITE(V1)
{
  int pcfState1 = param.asInt(); // assigning incoming value from pin V1 to a variable

  // process received value
  espPCF.setBit(1,pcfState1);
}
...
BLYNK_WRITE(V7)
{
  ...
  // process received value
  espPCF.setBit(7,pcfState7);
}


void setup() {
   //PCF
      espPCF.begin(0x38,D3,D1); //address, sda, scl
