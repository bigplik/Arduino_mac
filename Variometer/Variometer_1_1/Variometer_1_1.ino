...
float varioClimbRateStart;
float varioSinkRateStart;
...
//Serial.print("Altitude temp");
//Serial.println(altitude_temp);
//Serial.print("average_pressure ");
//Serial.println(average_pressure);
//Serial.print("climb rate ");
//Serial.println(varioClimbRateStart);
//Serial.print("sink rate ");
//Serial.println(varioSinkRateStart);
//Serial.print("current Altitude ");
//Serial.println(conf.currentAltitude);
//Serial.print("temp ");
//Serial.println((int)my_temperature);
//delay(500);
}
