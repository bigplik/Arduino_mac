...
//remote
#define openRMT digitalRead(8)==HIGH
#define closeRMT digitalRead(10)==HIGH
...
void loop() {
  ...
  //REMOTE DOOR CLOSING
//  else if(!CLOSING && !OPENING && closeRMT && !openRMT && !CLOSE && OPEN || !CLOSING && ! OPENING && closeRMT && !openRMT && !CLOSE && !OPEN){
//    OPENING = false, CLOSING = true;
//    digitalWrite(openMotPin,0);
//    delay(500);
//    digitalWrite(closeMotPin,1);
//  } 
  ...
  //REMOTE DOOR OPENING
//  else if(!OPENING && !CLOSING && openRMT && !closeRMT && CLOSE && !OPEN || !OPENING && !CLOSING && openRMT && !closeRMT && !CLOSE && !OPEN){
//    CLOSING = false, OPENING = true;
//    digitalWrite(closeMotPin,0);
//    delay(500);
//    digitalWrite(openMotPin,1);
...
//  //REMOTE STOP
    else if(OPENING && !CLOSING && openRMT || OPENING && !CLOSING && closeRMT || CLOSING && !OPENING && openRMT || CLOSING && !OPENING && closeRMT){
    digitalWrite(openMotPin,0);
    digitalWrite(closeMotPin,0);
    OPENING = false, CLOSING = false;
    delay(500);
