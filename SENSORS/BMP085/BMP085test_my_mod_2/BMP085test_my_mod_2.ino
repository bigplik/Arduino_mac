...
void loop() {
  ...
  if(realAlt < (countAlt-0.5)){ Serial.println("-1m/s"); }
  else if(realAlt > (countAlt+0.5)){ Serial.println("+1m/s");}
  ...
  // that is equal to 101500 Pascals.
    ...
    Serial.print(bmp.readAltitude(102600));
    Serial.println(" meters");
    
    Serial.print("start Alitude = ");
    Serial.print(bmp.readAltitude(102600)-startAltitude);
    Serial.println(" meters");
