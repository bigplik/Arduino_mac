...
//        u8g.drawStr( 25, 14, "BDS PPO2 Display");
        u8g.drawStr( 24, 60, "while_test_4_4_7_3");
...
//      else if ((PPO2 > 0.40 && PPO2 < 0.70) && (PPO22 > 0.40 && PPO22 < 0.70) && (PPO23 > 0.40 && PPO23 < 0.70)){
////orange LED on  
//       digitalWrite(redLED, 230);
//       digitalWrite(greenLED, 250);
//      }
...
//red LED on
  ...
  else if ((PPO2 > 0.39 && PPO2 < 0.70) && (PPO22 > 0.39 && PPO22 < 0.70) && (PPO23 > 0.39 && PPO23 < 0.70)){
//orange LED on  
  hud = 1;
      digitalWrite(greenLED, HIGH);
      digitalWrite(redLED, LOW);
