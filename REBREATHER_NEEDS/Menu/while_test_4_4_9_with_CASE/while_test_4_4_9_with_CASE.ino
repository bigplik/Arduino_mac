...
//  expander.pinMode(7, OUTPUT);
  expander.pinMode(6, OUTPUT); //batteryBCswitch
  //expander pin6 will open BC emiter and send 3.7V from li-ion
  //battery by BC transistor trough ADC port A0 of ADS1115
...
//  Serial.println("ADC Range: +/- 6.144V (1 bit = 3mV/ADS1015, 0.1875mV/ADS1115)");
  ...
  int16_t adc0, adc3, adc2, adc1;
//  adc3 = ads.readADC_SingleEnded(3);
//  adc2 = ads.readADC_SingleEnded(2);
//  adc1 = ads.readADC_SingleEnded(1);

//////////////////BATTERY CHECKING//////////////////////
  expander.pinMode(6, HIGH);//batteryBCswitch is now HIGH-OPEN
  //this will let to flow battery current into ADC0 port of ADS1115
...
void warning(){
  ...
  else if ((PPO2 >0.19 && PPO2 <0.40) && (PPO22 >0.19 && PPO22 <0.40) && (PPO23 >0.19 && PPO23 <0.40)){  
//red LED on
  hud = 0;
  }
  else if ((PPO2 > 0.40 && PPO2 < 0.70) && (PPO22 > 0.40 && PPO22 < 0.70) && (PPO23 > 0.40 && PPO23 < 0.70)){
//orange LED on  
  ...
  else if ( PPO2 > 1.39 || PPO22 >= 1.39 || PPO23 >= 1.39){
//red LED on
  hud = 3;
  }else{
//green LED on
  ...
  sw_secs.reset();
    ...
    switch(hud) {
      ...
      case 1:
            //orange LED on
            //if ((PPO2 > 0.40 && PPO2 < 0.70) 
            //&& (PPO22 > 0.40 && PPO22 < 0.70) 
            //&& (PPO23 > 0.40 && PPO23 < 0.70)) 
            u8g.setFont(u8g_font_courR14r);
            u8g.drawStr(69, 57, "^^^^^");
            analogWrite(redLED, 230);
            analogWrite(greenLED, 250);
      ...
      case 3:
           //red LED on 
           //if ( PPO2 >= 1.40 || PPO22 >= 1.40 || PPO23 >= 1.40)
           u8g.setFont(u8g_font_courR14r);
           u8g.drawStr(66,36, "HIGH");
           analogWrite(redLED, 255);
           analogWrite(greenLED, 0);
        break;
      case 4:
           //"LOW" sign just for <0.20 PPO2 segment
           u8g.drawStr(73, 36, "LOW");
        break;
