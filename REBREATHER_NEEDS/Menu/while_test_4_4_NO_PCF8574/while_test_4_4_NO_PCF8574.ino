...
S2mV = (firstValue2/4.95);
S3mV = (firstValue3/4.95); 
...
//    Serial.println(sw_secs.value());
  ...
  u8g_prepare();
      uint8_t a;
        u8g.setFont(u8g_font_timB18r);
        u8g.drawStr( 0, 25, "SETTINGS");  //1-szer, 2-wys,
        u8g.setFont(u8g_font_profont10);
    ...
    if(buttonState == HIGH){
      ...
      if(buttonState2 == HIGH){
          ...
          do {
            ...
            uint8_t a;
              u8g.setFont(u8g_font_timB18r);
              u8g.drawStr( 30, 40, "SAVE");  //1-szer, 2-wys,
            } while( u8g.nextPage() );
            delay(500);
        }
      }
...
//  Serial.println(" ");
  ...
  float SmVact = adc3/4.95;
  float SmVact2 = adc2/4.95;
  float SmVact3 = adc1/4.95;
