...
boolean statusS1 = true;
boolean statusS2 = true;
boolean statusS3 = true;
...
//average PPO2 calculations settings - take only working sensors
  if(statusS1 == true && statusS2 == true && statusS3 == true)        //TTT
  { avrPPO2 = (PPO2 + PPO22 + PPO23)/3;}
  else if(statusS1 == true && statusS2 == true && statusS3 == false)  //TTF
  { avrPPO2 = (PPO2 + PPO22)/2;}
  else if(statusS1 == true && statusS2 == false && statusS3 == false)  //TFF
  { avrPPO2 = PPO2;}
  else if(statusS1 == false && statusS2 == true && statusS3 == true)  //FTT
  { avrPPO2 = (PPO22 + PPO23)/2;}
  else if(statusS1 == false && statusS2 == true && statusS3 == false)  //FTF
  { avrPPO2 = PPO22;}
  else if(statusS1 == false && statusS2 == false && statusS3 == true)  //FFT
  { avrPPO2 = PPO23;}
  else if(statusS1 == true && statusS2 == false && statusS3 == true)  //TFT
  { avrPPO2 == (PPO2 + PPO23)/2;}
  else if(statusS1 == false && statusS2 == false && statusS3 == false)
  { avrPPO2 == (PPO2 + PPO22 + PPO23)/3;}
  delay(50);
