...
//      digitalWrite(1,HIGH);
  ...
  delay(200);
    ...
    mySerial.println("Fist Values");
    mySerial.print(firstValue1);mySerial.print(" ");
    mySerial.print(firstValue2);mySerial.print(" ");
    mySerial.println(firstValue3);
    delay(200);
    ...
    mySerial.println(" ");    
    mySerial.println("SmV values");
    mySerial.print(SmV);mySerial.print(" ");
    mySerial.print(S2mV);mySerial.print(" ");
    mySerial.println(S3mV);
       delay(200);
...
//        mySerial.println(" ");    
//        mySerial.println("SmV# values");
//        mySerial.print(SmV1);mySerial.print(" ");
//        mySerial.print(S2mV2);mySerial.print(" ");
//        mySerial.println(S3mV3);
...
//   allOff();
   ...
   mySerial.println(" ");
   mySerial.println("void setup passed"); 
   mySerial.println(" ");
   delay(200);
...
//  mySerial.println("adc raw data reads");
//  mySerial.print(adc1);
//  mySerial.print(" "); mySerial.print(adc2); mySerial.print(" ");
...
// 
//  mySerial.print(" ");
//  mySerial.print("loop - sensor status: ");
//  mySerial.println(sensorStatus);
  //delay(500);
...
//  mySerial.println("each PPO2");
  mySerial.println(PPO2);
  mySerial.println(PPO22);
  mySerial.println(PPO23);
...
//  mySerial.println("avrPPO2 hypOxic between 0.20-0.06");
//  }
//  else if(avrPPO2 > 0.19 && avrPPO2 < 0.4){ mySerial.println("avrPPO2 between 0.19-0.39"); }
//  else if(avrPPO2 > 0.39 && avrPPO2 < 0.7){ mySerial.println("avrPPO2 between 0.40-0.69"); }
//  else if(avrPPO2 > 0.69 && avrPPO2 < 1.21){ mySerial.println("avrPPO2 between 0.70-1.20"); }
//  else if(avrPPO2 > 1.20 && avrPPO2 < 1.4){ mySerial.println("avrPPO2 between 1.21-1.39"); }
//  else{ mySerial.println("avrPPO2 hyperOxic 1.40 and above"); }
//}
//
//void sos() {
