...
sw_secs.value(); sw_reset();*/
  ...
  Flasher slowG(1,500); Flasher slowR(3,500); Flasher slowB(4,500);
  Flasher fastG(1,200); Flasher fastR(3,200); Flasher fastB(4,200);
...
//battery volts interpretation
   if(battery >= 3.45){ digitalWrite(1,HIGH); }
   else if(battery < 3.45 && battery >= 3.2){ digitalWrite(4,HIGH); }
   else if(battery < 3.2 && battery >= 2.95){ digitalWrite(3,HIGH); }
   else{ fastR.flash(10); }
   delay(4000);
   allOff();
}
...
//  delay(500);
  ...
  Flasher slowG(1,500); Flasher slowR(3,500); Flasher slowB(4,500);
  Flasher fastG(1,200); Flasher fastR(3,150); Flasher fastB(4,200);
// 
...
void sos() {
Flasher fastRed(3,400); Flasher slowRed(3,800);
