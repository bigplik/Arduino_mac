...
SmV = (firstValue1/4.89); //dane przeliczone do miliVolt dla S1
S2mV = (firstValue2/4.89); //dla S2
...
void loop(){
    ...
    SmVact = (analogRead(A0)/5.0);
    SmVact2 = (analogRead(A1)/5.0);
      SmVact3 = (analogRead(A2)/5.0);
